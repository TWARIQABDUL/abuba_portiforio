      ...
      <div className="grid grid-cols-1 gap-12 md:grid-cols-5">
        <div className="md:col-span-3">
          <h1 className="font-headline text-4xl font-extrabold tracking-tight text-primary md:text-5xl">
            About Visual creators
          </h1>
          <Separator className="my-6" />
          <div className="space-y-6 text-lg text-foreground/80">
            <h2 className="font-headline text-3xl font-bold">My Journey</h2>
            <p>
              With over five years of dedicated experience in the art of cinematic storytelling, I founded Visual creators to bring a unique and high-end perspective to videography. My journey began in the vibrant markets of Rwanda, where I honed my skills capturing the nation's rich culture, breathtaking landscapes, and compelling human stories.
            </p>
            <p>
            ...
            <p>
              At Visual creators, we believe every project is a collaboration. We work closely with our clients to understand their vision and bring it to life with technical excellence and creative flair.
            </p>
          </div>
